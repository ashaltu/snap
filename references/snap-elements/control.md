...
![The when flag is clicked block shape](./assets/block_whenflagisclicked.png)
...
| Example | Definition |
|:- |:- |
| ![Alt text](./assets/block_whenflagisclicked_example.png) |  |



## When a key is pressed
![The when a key is pressed block shape](./assets/block_whenakeyispressed.png)
...
| Example | Definition |
|:- |:- |
| ![Alt text](./assets/block_whenakeyispressed_example.png) |  |



## When sprite is interacted with
![The when a sprite is interacted with block shape](./assets/block_whenaspriteisinteractedwith.png)
...
| Example | Definition |
|:- |:- |
| ![Alt text](./assets/block_whenaspriteisinteractedwith_example.png) |  |



## When
![The when block shape](./assets/block_when.png)
...
| Example | Definition |
|:- |:- |
| ![Alt text](./assets/block_when_example.png) |  |



## When a sprite receives a message
![The when a sprite receives a message block shape](./assets/block_whenaspritereceivesamessage.png)
...
| Example | Definition |
|:- |:- |
| ![Alt text](./assets/block_whenaspritereceivesamessage_example.png) |  |



## Broadcast
![The broadcast block shape](./assets/block_broadcast.png)
...
| Example | Definition |
|:- |:- |
| ![Alt text](./assets/block_broadcast_example.png) |  |



## Broadcast and wait
![The broadcast and wait block shape](./assets/block_broadcastandwait.png)
...
| Example | Definition |
|:- |:- |
| ![Alt text](./assets/block_broadcastandwait_example.png) |  |



## Message
![The message block shape](./assets/block_message.png)
...
| Example | Definition |
|:- |:- |
| ![Alt text](./assets/block_message_example.png) |  |



## Warp
![The warp block shape](./assets/block_warp.png)
...
| Example | Definition |
|:- |:- |
| ![Alt text](./assets/block_warp_example.png) |  |
